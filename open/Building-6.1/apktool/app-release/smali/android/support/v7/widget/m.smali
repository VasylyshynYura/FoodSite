...
# instance fields
.field a:Landroid/support/v7/widget/m$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->c:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/m;->e:Landroid/support/v7/widget/g;
    ...
    :goto_0
    iput-object v3, p0, Landroid/support/v7/widget/m;->f:Landroid/content/Context;
    ...
    :goto_1
    iput-object p5, p0, Landroid/support/v7/widget/m;->f:Landroid/content/Context;

    :goto_2
    iget-object p5, p0, Landroid/support/v7/widget/m;->f:Landroid/content/Context;
    ...
    :try_start_0
    sget-object p5, Landroid/support/v7/widget/m;->d:[I
    ...
    new-instance p4, Landroid/support/v7/widget/m$b;

    iget-object p5, p0, Landroid/support/v7/widget/m;->f:Landroid/content/Context;

    invoke-direct {p4, p0, p5, p2, p3}, Landroid/support/v7/widget/m$b;-><init>(Landroid/support/v7/widget/m;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p4, v1}, Landroid/support/v7/widget/m$b;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p4, v1}, Landroid/support/v7/widget/m$b;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {p5}, Landroid/support/v7/widget/aj;->a()V

    iput-object p4, p0, Landroid/support/v7/widget/m;->a:Landroid/support/v7/widget/m$b;

    new-instance p5, Landroid/support/v7/widget/m$1;

    invoke-direct {p5, p0, p0, p4}, Landroid/support/v7/widget/m$1;-><init>(Landroid/support/v7/widget/m;Landroid/view/View;Landroid/support/v7/widget/m$b;)V

    iput-object p5, p0, Landroid/support/v7/widget/m;->g:Landroid/support/v7/widget/u;
    ...
    invoke-virtual {p0, p5}, Landroid/support/v7/widget/m;->setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/m;->h:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/m;->h:Landroid/widget/SpinnerAdapter;

    :cond_9
    iget-object p1, p0, Landroid/support/v7/widget/m;->e:Landroid/support/v7/widget/g;
...
.method a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object p1, p0, Landroid/support/v7/widget/m;->c:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/m;->c:Landroid/graphics/Rect;
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/m;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/m;->setMeasuredDimension(II)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/m;->g:Landroid/support/v7/widget/u;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/m;->h:Landroid/widget/SpinnerAdapter;
...
.method public setPopupBackgroundResource(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/m;->setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
