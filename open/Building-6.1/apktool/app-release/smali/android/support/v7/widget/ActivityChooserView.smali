...
.field private final j:Landroid/support/v7/widget/v;
...
.field private n:Landroid/support/v7/widget/w;
...
.method a(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/w;

    move-result-object p1

    invoke-virtual {p1}, Landroid/support/v7/widget/w;->d()Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/w;->g(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/g/e;->a(Z)V

    :cond_4
    invoke-virtual {p1}, Landroid/support/v7/widget/w;->e()Landroid/widget/ListView;
...
.method getListPopupWindow()Landroid/support/v7/widget/w;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/w;
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/w;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/w;

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/w;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/ActivityChooserView$a;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/w;->a(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/w;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/w;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/w;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/w;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->i:Landroid/support/v7/widget/ActivityChooserView$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/w;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActivityChooserView;->j:Landroid/support/v7/widget/v;
    ...
    invoke-virtual {p1, p2, p2, p4, p5}, Landroid/support/v7/widget/v;->layout(IIII)V
...
.method protected onMeasure(II)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->j:Landroid/support/v7/widget/v;
