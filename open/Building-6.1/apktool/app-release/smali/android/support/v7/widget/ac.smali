...
.method private b()V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/v;
...
.method private d()Landroid/widget/Spinner;
    ...
    invoke-direct {v0, v1, v3, v2}, Landroid/support/v7/widget/m;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance v1, Landroid/support/v7/widget/v$a;

    const/4 v2, -0x2

    const/4 v3, -0x1

    invoke-direct {v1, v2, v3}, Landroid/support/v7/widget/v$a;-><init>(II)V
...
.method a(Landroid/support/v7/app/a$b;Z)Landroid/support/v7/widget/ac$c;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ac$c;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public a(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/v;->getChildAt(I)Landroid/view/View;
...
.method public onMeasure(II)V
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/v;

    invoke-virtual {v4}, Landroid/support/v7/widget/v;->getChildCount()I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/v;

    invoke-virtual {v1, v0, p2}, Landroid/support/v7/widget/v;->measure(II)V

    iget-object v0, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/v;

    invoke-virtual {v0}, Landroid/support/v7/widget/v;->getMeasuredWidth()I
...
.method public setTabSelected(I)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/v;

    invoke-virtual {v3, v2}, Landroid/support/v7/widget/v;->getChildAt(I)Landroid/view/View;
