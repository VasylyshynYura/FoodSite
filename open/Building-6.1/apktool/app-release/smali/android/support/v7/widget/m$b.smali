...
.method public constructor <init>(Landroid/support/v7/widget/m;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p2, p3, p4}, Landroid/support/v7/widget/w;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, Landroid/support/v7/widget/m$b;->i:Landroid/graphics/Rect;

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/m$b;->b(Landroid/view/View;)V

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/m$b;->a(Z)V

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/m$b;->a(I)V

    new-instance p2, Landroid/support/v7/widget/m$b$1;

    invoke-direct {p2, p0, p1}, Landroid/support/v7/widget/m$b$1;-><init>(Landroid/support/v7/widget/m$b;Landroid/support/v7/widget/m;)V

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/m$b;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/w;->a(Landroid/widget/ListAdapter;)V
...
.method f()V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/m;->c:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Landroid/support/v7/widget/m$b;->b:Landroid/support/v7/widget/m;

    invoke-static {v0}, Landroid/support/v7/widget/am;->a(Landroid/view/View;)Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/m;->c:Landroid/graphics/Rect;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/m;->c:Landroid/graphics/Rect;
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/m;->getPaddingRight()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/m$b;->b:Landroid/support/v7/widget/m;

    invoke-virtual {v3}, Landroid/support/v7/widget/m;->getWidth()I

    move-result v3

    iget-object v4, p0, Landroid/support/v7/widget/m$b;->b:Landroid/support/v7/widget/m;

    iget v4, v4, Landroid/support/v7/widget/m;->b:I
    ...
    iget-object v5, p0, Landroid/support/v7/widget/m$b;->a:Landroid/widget/ListAdapter;
    ...
    invoke-virtual {v4, v5, v6}, Landroid/support/v7/widget/m;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I

    move-result v4

    iget-object v5, p0, Landroid/support/v7/widget/m$b;->b:Landroid/support/v7/widget/m;

    invoke-virtual {v5}, Landroid/support/v7/widget/m;->getContext()Landroid/content/Context;
    ...
    iget-object v6, v6, Landroid/support/v7/widget/m;->c:Landroid/graphics/Rect;
    ...
    :goto_2
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/m$b;->g(I)V
    ...
    invoke-static {v4}, Landroid/support/v7/widget/am;->a(Landroid/view/View;)Z
    ...
    :goto_4
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/m$b;->c(I)V
