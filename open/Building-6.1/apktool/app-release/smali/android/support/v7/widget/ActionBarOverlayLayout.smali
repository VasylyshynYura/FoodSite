...
.field c:Landroid/support/v4/g/ah;

.field final d:Landroid/support/v4/g/ak;
...
.field private i:Landroid/support/v7/widget/q;
...
.field private y:Landroid/support/v4/widget/p;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->d:Landroid/support/v4/g/ak;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/g/r;

    return-void
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/widget/q;
    .locals 3
...
.method private a(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Landroid/support/v4/widget/p;->a(Landroid/content/Context;)Landroid/support/v4/widget/p;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/widget/p;
...
.method private a(FF)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/widget/p;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/widget/p;

    invoke-virtual {p1}, Landroid/support/v4/widget/p;->d()I
...
.method b()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/q;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/q;
...
.method c()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->c:Landroid/support/v4/g/ah;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->c:Landroid/support/v4/g/ah;

    invoke-virtual {v0}, Landroid/support/v4/g/ah;->a()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/g/v;->e(Landroid/view/View;)F
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/g/v;->h(Landroid/view/View;)I
    ...
    invoke-static {p0, p1, v1}, Landroid/support/v7/widget/am;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/g/v;->e(Landroid/view/View;)F
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/g/r;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/q;

    invoke-interface {v0}, Landroid/support/v7/widget/q;->a()Ljava/lang/CharSequence;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Landroid/support/v4/g/v;->i(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v2, v3}, Landroid/support/v7/widget/am;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/g/v;->d(Landroid/view/View;)I

    move-result v2

    invoke-static {v3, v2}, Landroid/support/v7/widget/am;->a(II)I
    ...
    invoke-static {v1, p1, v2}, Landroid/support/v4/g/v;->a(III)I

    move-result p1

    shl-int/lit8 v1, v2, 0x10

    invoke-static {v0, p2, v1}, Landroid/support/v4/g/v;->a(III)I
...
.method public setActionBarHideOffset(I)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/g/v;->a(Landroid/view/View;F)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/q;->a(Landroid/view/Window$Callback;)V
