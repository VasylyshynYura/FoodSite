...
.method public run()V
    ...
    invoke-static {v1}, Landroid/support/v4/g/v;->g(Landroid/view/View;)Landroid/support/v4/g/ah;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/g/ah;->a(F)Landroid/support/v4/g/ah;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout$3;->a:Landroid/support/v7/widget/ActionBarOverlayLayout;

    iget-object v2, v2, Landroid/support/v7/widget/ActionBarOverlayLayout;->d:Landroid/support/v4/g/ak;

    invoke-virtual {v1, v2}, Landroid/support/v4/g/ah;->a(Landroid/support/v4/g/ak;)Landroid/support/v4/g/ah;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->c:Landroid/support/v4/g/ah;
