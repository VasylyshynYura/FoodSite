.class public Landroid/support/v4/a/f$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/lang/String;Ljava/util/ArrayList;Landroid/os/Bundle;IILandroid/app/Notification;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v1, v0, Landroid/support/v4/a/f$a;->a:Landroid/app/Notification$Builder;

    new-instance v1, Landroid/os/Bundle;

    invoke-direct {v1}, Landroid/os/Bundle;-><init>()V

    iput-object v1, v0, Landroid/support/v4/a/f$a;->b:Landroid/os/Bundle;

    if-eqz v2, :cond_4

    iget-object v1, v0, Landroid/support/v4/a/f$a;->b:Landroid/os/Bundle;
    ...
    iget-object v3, v0, Landroid/support/v4/a/f$a;->a:Landroid/app/Notification$Builder;
    ...
    iput-object v2, v0, Landroid/support/v4/a/f$a;->c:Landroid/widget/RemoteViews;

    move-object/from16 v1, p29

    iput-object v1, v0, Landroid/support/v4/a/f$a;->d:Landroid/widget/RemoteViews;

    move-object/from16 v1, p30

    iput-object v1, v0, Landroid/support/v4/a/f$a;->e:Landroid/widget/RemoteViews;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Landroid/support/v4/a/f$a;->a:Landroid/app/Notification$Builder;
...
.method public a(Landroid/support/v4/a/h$a;)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/a/e;->a(Landroid/app/Notification$Builder;Landroid/support/v4/a/h$a;)V
...
.method public b()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/a/f$a;->b:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/a/f$a;->c:Landroid/widget/RemoteViews;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/a/f$a;->d:Landroid/widget/RemoteViews;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/a/f$a;->e:Landroid/widget/RemoteViews;
