.class public Landroid/support/v4/a/l$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v6, v0, Landroid/support/v4/a/l$a;->c:Ljava/util/List;
    ...
    iput-object v1, v0, Landroid/support/v4/a/l$a;->a:Landroid/app/Notification$Builder;

    new-instance v1, Landroid/os/Bundle;

    invoke-direct {v1}, Landroid/os/Bundle;-><init>()V

    iput-object v1, v0, Landroid/support/v4/a/l$a;->b:Landroid/os/Bundle;

    if-eqz v3, :cond_4

    iget-object v1, v0, Landroid/support/v4/a/l$a;->b:Landroid/os/Bundle;
    ...
    iput-object v1, v0, Landroid/support/v4/a/l$a;->d:Landroid/widget/RemoteViews;

    move-object/from16 v1, p25

    iput-object v1, v0, Landroid/support/v4/a/l$a;->e:Landroid/widget/RemoteViews;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Landroid/support/v4/a/l$a;->a:Landroid/app/Notification$Builder;
...
.method public a(Landroid/support/v4/a/h$a;)V
    ...
    iget-object v0, p0, Landroid/support/v4/a/l$a;->c:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/a/l$a;->a:Landroid/app/Notification$Builder;
...
.method public b()Landroid/app/Notification;
    ...
    invoke-static {v0}, Landroid/support/v4/a/k;->a(Ljava/util/List;)Landroid/util/SparseArray;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v1, p0, Landroid/support/v4/a/l$a;->b:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/a/l$a;->d:Landroid/widget/RemoteViews;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/a/l$a;->e:Landroid/widget/RemoteViews;
