...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v5, v0, Landroid/support/v4/a/k$a;->c:Ljava/util/List;
    ...
    iput-object v1, v0, Landroid/support/v4/a/k$a;->a:Landroid/app/Notification$Builder;

    new-instance v1, Landroid/os/Bundle;

    invoke-direct {v1}, Landroid/os/Bundle;-><init>()V

    iput-object v1, v0, Landroid/support/v4/a/k$a;->b:Landroid/os/Bundle;

    if-eqz v2, :cond_4

    iget-object v1, v0, Landroid/support/v4/a/k$a;->b:Landroid/os/Bundle;
    ...
    iput-object v1, v0, Landroid/support/v4/a/k$a;->d:Landroid/widget/RemoteViews;

    move-object/from16 v1, p23

    iput-object v1, v0, Landroid/support/v4/a/k$a;->e:Landroid/widget/RemoteViews;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Landroid/support/v4/a/k$a;->a:Landroid/app/Notification$Builder;

    return-object v0
.end method

.method public a(Landroid/support/v4/a/h$a;)V
    .locals 2

    iget-object v0, p0, Landroid/support/v4/a/k$a;->c:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/a/k$a;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/a/k;->a(Landroid/app/Notification$Builder;Landroid/support/v4/a/h$a;)Landroid/os/Bundle;
...
.method public b()Landroid/app/Notification;
    ...
    invoke-static {v0}, Landroid/support/v4/a/k;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    new-instance v2, Landroid/os/Bundle;

    iget-object v3, p0, Landroid/support/v4/a/k$a;->b:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/a/k$a;->c:Ljava/util/List;

    invoke-static {v1}, Landroid/support/v4/a/k;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v4/a/k$a;->d:Landroid/widget/RemoteViews;
    ...
    :cond_3
    iget-object v1, p0, Landroid/support/v4/a/k$a;->e:Landroid/widget/RemoteViews;
