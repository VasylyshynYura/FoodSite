...
.method constructor <init>(Landroid/support/a/a/f$f;)V
    ...
    iget-object p1, p1, Landroid/support/a/a/f$f;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v0, v1, p1}, Landroid/support/a/a/f;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object p1

    iput-object p1, p0, Landroid/support/a/a/f;->d:Landroid/graphics/PorterDuffColorFilter;
...
.method public static a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/a/a/f;
    ...
    iput-object p0, v0, Landroid/support/a/a/f;->b:Landroid/graphics/drawable/Drawable;

    new-instance p0, Landroid/support/a/a/f$g;

    iget-object p1, v0, Landroid/support/a/a/f;->b:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p1}, Landroid/graphics/drawable/Drawable;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;

    move-result-object p1

    invoke-direct {p0, p1}, Landroid/support/a/a/f$g;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    iput-object p0, v0, Landroid/support/a/a/f;->h:Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    invoke-static {p0, p1, v0, p2}, Landroid/support/a/a/f;->a(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/a/a/f;
...
.method private a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget v3, v1, Landroid/support/a/a/f$e;->b:F
    ...
    invoke-virtual {v1, p2}, Landroid/support/a/a/f$e;->setAlpha(F)V
    ...
    iput-object p1, v1, Landroid/support/a/a/f$e;->g:Ljava/lang/String;

    iget-object p2, v1, Landroid/support/a/a/f$e;->h:Landroid/support/v4/f/a;
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v3, v1, Landroid/support/a/a/f$e;->a:Landroid/support/a/a/f$c;
    ...
    check-cast v7, Landroid/support/a/a/f$c;
    ...
    invoke-virtual {v3, p1, p3, p4, p2}, Landroid/support/a/a/f$b;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v6, v7, Landroid/support/a/a/f$c;->a:Ljava/util/ArrayList;

    invoke-virtual {v6, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v3}, Landroid/support/a/a/f$b;->getPathName()Ljava/lang/String;

    move-result-object v6

    if-eqz v6, :cond_1

    iget-object v6, v1, Landroid/support/a/a/f$e;->h:Landroid/support/v4/f/a;
    ...
    iget v7, v0, Landroid/support/a/a/f$f;->a:I

    iget v3, v3, Landroid/support/a/a/f$b;->o:I
    ...
    new-instance v3, Landroid/support/a/a/f$a;

    invoke-direct {v3}, Landroid/support/a/a/f$a;-><init>()V

    invoke-virtual {v3, p1, p3, p4, p2}, Landroid/support/a/a/f$a;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v7, v7, Landroid/support/a/a/f$c;->a:Ljava/util/ArrayList;

    invoke-virtual {v7, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v3}, Landroid/support/a/a/f$a;->getPathName()Ljava/lang/String;

    move-result-object v7

    if-eqz v7, :cond_3

    iget-object v7, v1, Landroid/support/a/a/f$e;->h:Landroid/support/v4/f/a;
    ...
    iget v3, v3, Landroid/support/a/a/f$a;->o:I

    :goto_1
    or-int/2addr v3, v7

    iput v3, v0, Landroid/support/a/a/f$f;->a:I
    ...
    new-instance v3, Landroid/support/a/a/f$c;

    invoke-direct {v3}, Landroid/support/a/a/f$c;-><init>()V

    invoke-virtual {v3, p1, p3, p4, p2}, Landroid/support/a/a/f$c;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-virtual {v3}, Landroid/support/a/a/f$c;->getGroupName()Ljava/lang/String;
    ...
    iget v3, v3, Landroid/support/a/a/f$c;->c:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Landroid/support/a/a/f;->i:[F
    ...
    iget-object v8, p0, Landroid/support/a/a/f;->k:Landroid/graphics/Rect;
    ...
    invoke-virtual {v2, v1, v3}, Landroid/support/a/a/f$f;->b(II)V
    ...
    invoke-virtual {v2, v1, v3}, Landroid/support/a/a/f$f;->a(II)V
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object p1, p0, Landroid/support/a/a/f;->d:Landroid/graphics/PorterDuffColorFilter;

    iget-object p2, v0, Landroid/support/a/a/f$f;->c:Landroid/content/res/ColorStateList;

    iget-object p3, v0, Landroid/support/a/a/f$f;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, p1, p2, p3}, Landroid/support/a/a/f;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method protected onStateChange([I)Z
    ...
    :cond_0
    iget-object p1, p0, Landroid/support/a/a/f;->c:Landroid/support/a/a/f$f;
...
.method public setTint(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/a/a/f;->setTintList(Landroid/content/res/ColorStateList;)V
